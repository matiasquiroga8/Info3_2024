...
import TrabajandoelOrdenador.OrdenamientoPorInsercion;
...
public class MainconInsercion {
    public static void main(String[] args) {
        ...
        // Medir el tiempo de ejecución del ordenamiento por inserción
        long inicioTiempo = System.currentTimeMillis();
        OrdenamientoPorInsercion.ordenarPorTiempoPreparacion(listaPedidos);
        long finTiempo = System.currentTimeMillis();
        long tiempoEjecucion = finTiempo - inicioTiempo;

        // Listar todos los pedidos ordenados por tiempo de preparación
        System.out.println("Lista de Pedidos Ordenados por Tiempo de Preparación:");
        for (Pedido01 pedido : listaPedidos) {
            System.out.println(pedido);
        }

        // Imprimir el tiempo de ejecución
        System.out.println("\nTiempo de ejecución del ordenamiento por Inserción: " + tiempoEjecucion + " milisegundos");
